...
import { haveEnoughInventory } from '../_utils/helpers';
...
const SandwichMaker = () => {
  ...
  return (
    <>
      <h4>Kitchen</h4>
      <button disabled={!haveEnoughInventory(state)} onClick={() => dispatch({ type: Actions.MAKE_SANDWICH })}>Make Sandwich</button>
